...
training_image_files_crack = [f for f in os.listdir('/home/siddharth/cnn/data/data/train_handle/') if '.jpg' in f]
training_image_files_no_crack = [f for f in os.listdir('/home/siddharth/cnn/data/data/train_non_handle/') if '.jpg' in f]
validation_image_files_crack = [f for f in os.listdir('/home/siddharth/cnn/data/data/validate_handle/') if '.jpg' in f]
validation_image_files_no_crack = [f for f in os.listdir('/home/siddharth/cnn/data/data/validate_non_handle/') if '.jpg' in f]
test_image_files = [f for f in os.listdir('/home/siddharth/cnn/data/data/test/') if '.jpg' in f]
...
for i in range(0, len(training_image_files_crack)):
    image = data.imread('data/data/train_handle/'+training_image_files_crack[i])
    training_images.append(image)
    training_labels.append(0)

for i in range(0, len(training_image_files_no_crack)):
    image = data.imread('data/data/train_non_handle/'+training_image_files_no_crack[i])
    training_images.append(image)
    training_labels.append(1)

for i in range(0, len(validation_image_files_crack)):
    image = data.imread('data/data/validate_handle/'+validation_image_files_crack[i])
    validation_images.append(image)
    validation_labels.append(0)

for i in range(0, len(validation_image_files_no_crack)):
    image = data.imread('data/data/validate_non_handle/'+validation_image_files_no_crack[i])
    validation_images.append(image)
    validation_labels.append(1)

for i in range(0, len(test_image_files)):
    image = data.imread('data/data/test/'+test_image_files[i])
...
for i in range(0, len(rounded_predictions)):
    if rounded_predictions[i] == 0:
        print("This image is a door handle")
    if rounded_predictions[i] == 1:
       print("This image is not a door handle")
